...
-- Confirmed diagnosis/problem list
...
-- Confirmed interventions: medication, supplement, lifestyle, training, etc.
...
-- Structured clinical test/imaging registry (CPET, Kinemo, carotid ultrasound, etc.)
